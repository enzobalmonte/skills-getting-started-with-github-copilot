...
activities = {
    ...
    "Swim Club": {
        "description": "Build swimming skills and train for friendly competitions",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": []
    },
    "Drama Club": {
        "description": "Rehearse scenes, perform plays, and explore theatrical arts",
...
def unregister_participant(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(status_code=400, detail="Participant not found for this activity")
